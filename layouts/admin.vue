  ...
  <div class="admin-shell">
    ...
    <aside class="sidebar" :class="{ open: drawerOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <NuxtLink to="/admin/skills" class="nav-item" active-class="active" @click="drawerOpen = false">
        ...
        <NuxtLink to="/admin/settings/models" class="nav-item" active-class="active" @click="drawerOpen = false">
        ...
        <NuxtLink to="/admin/database" class="nav-item" active-class="active" @click="drawerOpen = false">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>
          数据库
        </NuxtLink>
      </nav>
